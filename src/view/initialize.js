...
exports.buildFrame = (boxid, size) => {
    ...
    outer.appendChild(loadingLayer);
    ...
    * */
    ...
    function loadedCheck() {
        if (numberOfLoaded === 0) { // If non of the picture has already loaded.
            ...
            // render them
            require("./animation").disappear(document.getElementById("zcapt-loadingLayer"),0.08,() => {
